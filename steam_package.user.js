...
$('.help_purchase_detail_box').after('<div id="a"></div>');
$('.help_purchase_detail_box').after('<div id="b"></div>');
$('.help_purchase_detail_box').after('<div id="c"></div><br>');
$('.help_purchase_detail_box').after('<div><a href="javascript:void(0);" onclick="addman();">ADDMAN</a></div>');
$('.help_purchase_detail_box').after('<div><a href="javascript:void(0);" onclick="rmman();">REMOVE</a></div>');
$('.help_purchase_detail_box').after('<div><a href="javascript:void(0);" onclick="reman();">RESTORE</a></div>');;
